...
**p_int is a pointer that points to the memory location used by the counter variable, ++(*p_int) first dereferences and points to the value of counter and then increments the value in counter**
