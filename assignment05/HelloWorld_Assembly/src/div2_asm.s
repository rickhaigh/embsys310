...
*******************************************************************************/   
    ...
    PUBLIC div2_asm     // Exports symbols to other modules
                        // Making div2_asm available to other modules.
...
div2_asm
    ...
    MOV R1, #2          // store constant 2 used to divide input arg by 
    POP {R0,LR}         // Restore R0 and LR
    SDIV R0, R0, R1     // R0 = R0 / 2 
